...
const ContactSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[90rem] flex flex-col xl:flex-row items-center xl:items-start justify-center gap-16 xl:gap-24 pt-10 sm:pt-16 pb-12 w-full">
        {/* Contact cards - 3D Isometric */}
        <div className="flex-1 flex flex-col justify-center w-full max-w-2xl xl:pt-12">
          <div className="flex flex-wrap justify-center gap-12 sm:gap-16 xl:gap-x-12 xl:gap-y-20">
        ...
        <div className="flex-1 w-full max-w-2xl">
          <FadeIn delay={0.4} y={30}>
            <div className="mb-10 text-center xl:text-left">
              ...
              <div className="h-px w-16 bg-white/20 mx-auto xl:mx-0" />
            </div>
